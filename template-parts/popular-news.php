<section class="container gutter">
        ...
        <div class="row ">
            <div class="popular-item">
                <a href="#">
                    <div class="popular-item-img" style="background-image: url(img/preview/popular-1.jpg);"></div>
                </a>
            ...
            <div class="popular-item">
                <a href="#">
                    <div class="popular-item-img" style="background-image: url(img/preview/popular-2.jpg);"></div>
                </a>
            ...
            <div class="popular-item">
                <a href="#">
                    <div class="popular-item-img" style="background-image: url(img/preview/popular-3.jpg);"></div>
                </a>
            ...
            <div class="popular-item">
                <a href="#">
                    <div class="popular-item-img" style="background-image: url(img/preview/popular-4.jpg);"></div>
                </a>
                <div class="popular-item-head"><a href="#">Williams wins first WTA Tour match after birth of child</a></div>
                <div class="popular-item-more"><span class="icon-eye-1">28 </span><span class="popular-item-more-separator"></span><span class="icon-comment-1">33</span></div>
            </div>
            <div class="popular-item">
                <a href="#">
                    <div class="popular-item-img" style="background-image: url(img/preview/popular-5.jpg);"></div>
                </a>
                <div class="popular-item-head"><a href="#">Kyrgios and Cilic out of Miami Open</a></div>
                <div class="popular-item-more"><span class="icon-eye-1">28 </span><span class="popular-item-more-separator"></span><span class="icon-comment-1">33</span></div>
            </div>
            <div class="popular-item">
                <a href="#">
                    <div class="popular-item-img" style="background-image: url(img/preview/popular-6.jpg);"></div>
                </a>
                <div class="popular-item-head"><a href="#">I'm back and ready - Serena Williams</a></div>
                <div class="popular-item-more"><span class="icon-eye-1">28 </span><span class="popular-item-more-separator"></span><span class="icon-comment-1">33</span></div>
            </div>
